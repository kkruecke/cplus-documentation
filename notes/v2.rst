...
Move semantics, introduced in C++11, lead to a (BS start-->) "more refined view of lvalue and rvalue. There are two properties that matter for for an object when it comes to addressing, copying and moving:
...
.. todo:: Use BS example on page 166 and any cppreference examples. Synthesize any important explanations from the other articles, including Dr. Sheep's videi, and provide examples at top. Finally add BS's conclusion from C++PL that the two practical
   categories are rvalue and value. Add a final comment about C++17 and materialization.
