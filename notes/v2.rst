...
.. todo:: synthesize any important explanations from the other articles and provide examples that explain each of the value categories. Finally add BS's conclusion from C++PL that the two practical categories are rvalue and value. Add a final comment about
   C++17 and materialization. Include points and/or examples from the the Dr. Sheep lecture.
